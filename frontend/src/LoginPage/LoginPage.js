...
const LoginPage = (props) => {
  ...
  const handleLogin = async (e) => {
    ...
    axios
      .post('http://45.55.66.19:3002/', loginFormData)
      .then((response) => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://45.55.66.19:3002/signup', signupFormData);

      setSuccessMessage(response.data.message);

      const loginResponse = await axios.post('http://45.55.66.19:3002/', {
